...
class FavorisStationPage extends StatefulWidget {
  @override
  _FavorisStationPageState createState() => _FavorisStationPageState();
}

class _FavorisStationPageState extends State<FavorisStationPage> {
  @override
